...
<body>
                    ...
                    <ul class="nav flex-column">
                        <li class="nav-item" style="margin-bottom: 40px;">
                            <div class="row align-items-start">
                                ...
                                <div class="col">
                                    <img src="./images/logos_android-vertical.png" alt="learning-logo"
                                        style="height: 65px;">
                                </div>
                            </div>
                        </li>
                ...
                <div class="modal-dialog" style="width: 420px">
                    <div class="modal-content">
                        ...
                        <div class="modal-body text-center">
                            ...
                            <p class="text" style="font-size: 18px">Click the enroll button to start<br>your
                                learning!</p>
                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col" style="text-align: right;">
                                                <div class="custom-button-detail">
                                                    ...
                                                    <a href="{{ route('student.learning.detail.task', $item->id) }}" style="text-decoration: none">
                                                        <p class="button-text">
                                                        <i class="fas fa-key" style="margin-right: 5px;"></i>
                                                        Material Details
                                                    </p>
    ...
    <script>
        ...
        const buttons = document.querySelectorAll('.button-text[data-toggle="modal"]');

        buttons.forEach(button => {
            button.addEventListener('click', function () {
                const itemId = this.getAttribute('data-id');
                const route = `{{ route('student.learning.detail.task', ':id') }}`.replace(':id', itemId);
