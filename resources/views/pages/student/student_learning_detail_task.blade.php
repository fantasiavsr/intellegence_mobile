...
<body>
     ...
     <div id="sidebar" class="sidebar" style="border-left: 1px solid #E4E4E7; padding: 30px 30px; width: 400px">
        ...
        <ul class="list">
            <li class="list-item" onclick="toggleItem(this)">
                ...
                <span class="list-item-title">{{ $topic->name }}</span>
            </li>
            <div class="expandable-content">
                ...
                <div style="display: flex; flex-direction: column; align-items: left;">
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            <a href="" style="text-decoration: none"><p class="text" id="requirement">{{ $item->desc }}</p></a>
    ...
    <div style="padding-top: 36px; padding-left: 80px; padding-right:450px">
        <p class="text-list" style="font-size: 36px; font-weight: 600">
            {{ $topic->name }}
        </p>
        <div class="row">
            <div class="col">
                <iframe src="{{ route('pdf.show', $thistask->id) }} }}" width="100%" height="600px"></iframe>
            </div>
            <div class="col-md-5">
                {{-- <pre>test</pre> --}}
